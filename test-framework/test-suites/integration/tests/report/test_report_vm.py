...
class TestReportVM:
	...
	def test_report_vm_disk_images(self, add_hypervisor, add_vm_multiple, create_image_files, test_file, host):
		"""
		...
		# Archives can contain multiple disks
		# so we want to skip adding the same
		# archive twice

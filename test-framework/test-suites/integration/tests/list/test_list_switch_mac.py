...
class TestListSwitchMac:
    def test_x1052(self, host, add_host, inject_code, test_file):
        ...
        result = host.run(
            "stack add host interface backend-0-0 mac=00:00:00:00:00:00 ip=127.0.0.2 interface=eth0 network=private"
        )
        assert result.rc == 0
        ...
        with inject_code(test_file("list/mock_switch_mac_test_x1052.py")):

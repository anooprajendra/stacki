            ...
            [
                {
                    ...
                    "make": "mellanox",
                    "model": "m7800",
                    "desired_firmware_version": "1.2.3",
                    "current_firmware_version": "0.0.0",
                },
                {
                    "host": "backend-0-1",
                    "make": "dell",
                    "model": "x1052-software",
                    "desired_firmware_version": "1.2.3.4",
                    "current_firmware_version": "0.0.0.0",
                },
                {
                    "host": "frontend-0-0",
                    "make": None,
...
def test_list_host_firmware(
    ...
    result = host.run(
        f"stack add firmware 1.2.3.4 make=dell model=x1052-software source={fake_local_firmware_file} hosts=backend-0-1"
    )
    assert result.rc == 0

...
class TestBossConfigSnack:
    ...
    def mount_cdrom(self):
        ...
        subprocess.run(
            "mount /export/isos/stacki-*.iso /mnt/cdrom", shell=True, check=True
        )
    ...
    def test_minimal(
        self, host, host_os, mount_cdrom, no_site_attrs, no_rolls_xml, test_file
    ):

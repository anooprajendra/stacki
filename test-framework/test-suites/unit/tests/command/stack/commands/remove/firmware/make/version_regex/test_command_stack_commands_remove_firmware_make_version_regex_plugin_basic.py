...
class TestRemoveFirmwareMakeVersionRegexBasicPlugin:
    ...
    @patch(
        target="stack.commands.remove.firmware.make.version_regex.plugin_basic.lowered",
        autospec=True,
    )
    @patch(
        target="stack.commands.remove.firmware.make.version_regex.plugin_basic.unique_everseen",
        autospec=True,
    )

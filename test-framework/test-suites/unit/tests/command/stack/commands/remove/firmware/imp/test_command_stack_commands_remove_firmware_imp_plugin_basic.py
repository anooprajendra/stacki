...
class TestRemoveFirmwareImpBasicPlugin:
    ...
    @patch(
        target="stack.commands.remove.firmware.imp.plugin_basic.lowered", autospec=True
    )
    @patch(
        target="stack.commands.remove.firmware.imp.plugin_basic.unique_everseen",
        autospec=True,
    )

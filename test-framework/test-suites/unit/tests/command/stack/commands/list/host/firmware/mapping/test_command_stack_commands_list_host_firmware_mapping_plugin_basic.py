...
@pytest.mark.parametrize(
    "hosts", ("", "backend-0-0", "backend-0-1", "backend-0-0 backend-0-1")
)
@pytest.mark.parametrize(
    "make, model, versions",
    (

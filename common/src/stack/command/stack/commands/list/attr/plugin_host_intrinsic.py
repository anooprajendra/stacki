    ...
    def run(self, scope_mappings):
        ...
        if node_ids:
			...
			""",
                ...
                if environment:
                    output_rows.append(
                        [hostname, "host", "const", "environment", environment]
                    )
                ...
                if metadata:
                    output_rows.append(
                        [hostname, "host", "const", "metadata", metadata]
                    )
            ...
            for box_id in box_map:
                ...
                for hostname in box_map[box_id]:
                    ...
                    output_rows.append(
                        [hostname, "host", "const", "os.version", os_version]
                    )
			...
			""",
                ...
                output_rows.append(
                    [hostname_map[node_id], "host", "const", "domainname", zone]
                )

                if address:
                    output_rows.append(
                        [hostname_map[node_id], "host", "const", "hostaddr", address]
                    )
			...
			""",
                ...
                output_rows.append(
                    [hostname_map[node_id], "host", "const", f"group.{group}", "true"]
                )

            for node_id in node_ids:
                output_rows.append(
                    [
                        hostname_map[node_id],
                        "host",
                        "const",
                        "groups",
                        " ".join(groups[node_id]),

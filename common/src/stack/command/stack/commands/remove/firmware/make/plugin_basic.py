...
from stack.exception import ArgError, ArgRequired, CommandError
...
class Plugin(stack.commands.Plugin):
        ...
        for make in makes:
            ...
            if models_to_remove:
                self.owner.call(
                    ...
                    args=[*models_to_remove, f"make={make}"],
                )
    ...
    def run(self, args):
        ...
        self.owner.db.execute("DELETE FROM firmware_make WHERE name IN %s", (makes,))

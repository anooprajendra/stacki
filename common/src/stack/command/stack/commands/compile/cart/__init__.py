...
class Command(stack.commands.CartArgumentProcessor, stack.commands.compile.command):
    """
    ...
    def doRepo(self, cart):
        ...
        if os.path.exists(fingerprint):
            ...
            for line in file.readlines():
                ...
                if len(l) == 3:
                    ...
                    existingfinger[fname] = {"size": fsize, "mtime": fmtime}
            file.close()
        ...
        for dirpath, dirnames, filenames in os.walk(cartpath):
            ...
            for file in filenames:
                ...
                #
                newfinger[filepath] = {"size": fsize, "mtime": fmtime}
        ...
        if existingfinger != newfinger:
            ...
            perms = perms | stat.S_IRGRP | stat.S_IXGRP | stat.S_IWGRP

...
"""
Django settings for Stack RestAPI project.
...
f = open("/opt/stack/etc/django.secret", "r")
...
AUTHENTICATION_BACKENDS = ["stack.restapi.auth.CommandBackend"]

ROOT_URLCONF = "stack.restapi.urls"
...
WSGI_APPLICATION = "stack.restapi.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {"read_default_file": "/opt/stack/etc/django.my.cnf"},
        "NAME": "django",
    }
}
